...
p:
  ...
  .elseif g_map[esi] == 10 || g_map[esi] == 101
		.if bombing1 == 0
			
		.else
			.if bomb_count1 != 0
				invoke SelectObject, g_bufdc, g_hBlack
				invoke BitBlt, g_mdc, @col, @row, 50, 50, g_bufdc, 0, 0, SRCAND
				mov ecx, @col
				mov edx, @row
				sub ecx, 50
				invoke BitBlt, g_mdc, ecx, edx, 50, 50, g_bufdc, 0, 0, SRCAND
				mov ecx, @col
				mov edx, @row
				sub edx, 50
				invoke BitBlt, g_mdc, ecx, edx, 50, 50, g_bufdc, 0, 0, SRCAND
				...
				invoke BitBlt, g_mdc, @col, @row, 50, 50, g_bufdc, 0, 0, SRCPAINT
				mov ecx, @col
				mov edx, @row
				sub ecx, 50
				invoke BitBlt, g_mdc, ecx, edx, 50, 50, g_bufdc, 0, 0, SRCPAINT
				mov ecx, @col
				mov edx, @row
				sub edx, 50
				invoke BitBlt, g_mdc, ecx, edx, 50, 50, g_bufdc, 0, 0, SRCPAINT
