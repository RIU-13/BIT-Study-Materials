...
.while @counter<255
    ...
    .if @distance<=1
       ...
       ; invoke printf ,offset szOutMsg, g_map[edx]
        ...
        .if g_map[edx] == 08h || g_map[edx] == 101
                 invoke SelectObject, g_bufdc, g_hEnd
	             invoke BitBlt, g_mdc, 0, 0, 795, 765, g_bufdc, 0, 0, SRCCOPY
        ...
        .endif 
        .if g_map[edx] == 09h || g_map[edx] == 102
            invoke SelectObject, g_bufdc, g_hEnd
	        invoke BitBlt, g_mdc, 0, 0, 795, 765, g_bufdc, 0, 0, SRCCOPY
	        invoke BitBlt, g_hdc, 0, 0, WINDOW_WIDTH, WINDOW_HEIGHT, g_mdc, 0, 0, SRCCOPY
...
GameInit proc hwnd:HWND
  ...
  invoke LoadImage, NULL, offset g_start, IMAGE_BITMAP, 1591, 768, LR_LOADFROMFILE
  mov g_hStart, eax

  invoke LoadImage, NULL, offset g_end, IMAGE_BITMAP, 795, 765, LR_LOADFROMFILE
  mov g_hEnd, eax
...
GamePaint proc hwnd:HWND
  ...
  local @startcount:dword
  local @startcoord:dword
   ;游戏开始界面
  .if start == 0
	;invoke printf, offset szFmt
	invoke SelectObject, g_bufdc, g_hStart
	...
	invoke BitBlt, g_mdc, 0, 0, 795, 765, g_bufdc, @startcoord, 0, SRCCOPY
	invoke BitBlt, g_hdc, 0, 0, WINDOW_WIDTH, WINDOW_HEIGHT, g_mdc, 0, 0, SRCCOPY
	invoke GetTickCount
	mov g_tPre, eax	
...
p:
	...
	.if g_map[esi] == 0 || g_map[esi] == 8 || g_map[esi] == 9
